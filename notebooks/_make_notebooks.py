...
nb01 = nb([
    ...
    code(
        "loaded = load_model(MODELS['tinyllama'], device='auto', dtype='float32')\n"
...
nb04 = nb([
    ...
    code(
        ...
        "             save_to=str(RESULTS_DIR / 'tinyllama_heatmap.png'))\n"
    ),
    code(
        "agg.to_csv(RESULTS_DIR / 'tinyllama_patch_z.csv', index=False)\n"
...
nb05 = nb([
    ...
    code(
        "loaded = load_model(MODELS['tinyllama'])\n"
        "agg = pd.read_csv(RESULTS_DIR / 'tinyllama_patch_z.csv')\n"
